            ...
            <div className="container">
                <section className="align-items-center auth-wrap d-flex">
                    <div className="auth-inner flex-grow-1">
                        <h4 className="auth-title fw-bold text-center mb30">
                            Create Your Account
                        </h4>
                        <p className="fz13 lh-base mb50 text-center">
                            By creating an account, you agree to our{" "}
                            <a href="#" className="fw-medium text-decoration-underline">
                                Terms of Service
                            </a>
                            <br /> and have read and understood the{" "}
                            <a href="#" className="fw-medium text-decoration-underline">
                                Privacy Policy
                            </a>
                        </p>
                        <div className="auth-box">
                            <div className="auth-form d-flex mb50">
                                        ...
                                        <div className="mb30">
                                            ...
                                            <div className="position-relative">
                                                <input
                                                    id="confirmPassword"
                                                    type="password"
                                                    className="form-control auth-input c-password"
